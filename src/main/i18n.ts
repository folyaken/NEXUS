...
const EN: Record<string, string> = {
  ...
  'Прокси, адаптеры и маршруты': 'Proxy, adapters and routes',
  'Отчёт сети записан в журнал': 'Network report written to the log',
  'Не удалось собрать отчёт сети': 'Could not collect the network report',
  'Проверка сети доступна в установленной программе': 'Network check is available in the installed app',
  ...
  'Справочник отвечает': 'Resolver responds',
  'Справочник не отвечает': 'Resolver is not responding',
  'Не удалось проверить справочник': 'Could not test the resolver',
  'Выбран справочник Windows — проверять нечего': 'The Windows resolver is selected — nothing to test',
  'Не удалось измерить справочники': 'Could not measure the resolvers',
  'Ни один справочник не ответил': 'No resolver responded',
  'Самый быстрый': 'Fastest',
  'Нет ответа': 'No response',
  'нет ответа': 'no response',
  'выбран': 'selected',
  'Выбрать': 'Select',
  'Загрузить набор': 'Load set',
  'Сохранить набор': 'Save set',
  'Набором можно поделиться: обычный файл JSON.': 'A set is a plain JSON file — easy to share.',
  'Набор правил сохранён': 'Rule set saved',
  'Не удалось сохранить набор': 'Could not save the set',
  'Не удалось загрузить набор': 'Could not load the set',
  'Новых правил в файле нет': 'No new rules in the file',
  'Добавлено правил': 'Rules added',
  'пропущено': 'skipped',
  'Файл повреждён или это не набор правил': 'The file is damaged or is not a rule set',
  'Это файл от другой программы': 'This file belongs to another program',
  'Файл создан более новой версией NEXUS': 'The file was created by a newer version of NEXUS',
  'В файле нет правил': 'The file has no rules',
  'В файле не оказалось подходящих правил': 'No usable rules were found in the file',
  'Не удалось прочитать файл': 'Could not read the file',
  'Сервер не ответил': 'The server did not respond',
  'Сервер ответил ошибкой': 'The server returned an error',
  'Защищённый адрес — проверяется при подключении': 'Secure address — verified on connection',
  'Запрос заблокирован системой или брандмауэром': 'The request was blocked by the system or firewall',
  ...
  'Одни сайты идут напрямую, другие через VPN, третьи не открываются вовсе. Работает только для VPN.': 'Some sites go directly, others through the VPN, and the rest are blocked. Applies to the VPN only.',
  'example.com, *.example.com или 10.0.0.0/8': 'example.com, *.example.com or 10.0.0.0/8',
  'Домен или адрес': 'Domain or address',
  'Куда направить': 'Where to send it',
  'Блокировать': 'Block',
  'Готовые наборы': 'Ready-made sets',
  'Поднять правило выше': 'Move rule up',
  'Выключить правило': 'Turn rule off',
  'Включить правило': 'Turn rule on',
  'Правил пока нет': 'No rules yet',
  'Весь трафик идёт через VPN. Добавьте правило или выберите готовый набор выше.': 'All traffic goes through the VPN. Add a rule or pick a ready-made set above.',
  'Правила применяются сверху вниз: срабатывает первое подходящее. Изменения вступают в силу сразу — активное подключение перезапустится.': 'Rules apply top to bottom: the first match wins. Changes take effect at once — an active connection restarts.',
  'Неверный адрес. Пример: example.com, *.example.com или 10.0.0.0/8': 'Invalid address. For example: example.com, *.example.com or 10.0.0.0/8',
  'Такое правило уже есть': 'That rule already exists',
  'Достигнут предел числа правил': 'Rule limit reached',
  'Правило добавлено': 'Rule added',
  'Реклама и слежка': 'Ads and tracking',
  'Рекламные и следящие домены. Обычно их блокируют.': 'Ad and tracking domains. Usually blocked.',
  'Российские сайты': 'Russian sites',
  'Госуслуги, банки, локальные сервисы. Обычно — напрямую.': 'Government services, banks, local services. Usually direct.',
  'Российские адреса': 'Russian addresses',
  'Серверы, расположенные в России.': 'Servers located in Russia.',
  'Домашняя сеть': 'Home network',
  'Роутер, принтер, сетевой диск. Всегда напрямую.': 'Router, printer, network drive. Always direct.',
  ...
  'Папка с логами доступна в установленной программе': 'The logs folder is available in the installed app',
  ...
  'Подключиться к лучшему': 'Connect to fastest',
  'Подключаемся…': 'Connecting…',
  'Подключено к лучшему': 'Connected to fastest',
  'Замеряем пинг…': 'Measuring ping…',
  'Нет доступных серверов': 'No available servers',
  'Уже подключены к самому быстрому серверу': 'Already connected to the fastest server',
  'Не удалось измерить пинг': 'Could not measure ping',
  '· замеряем…': '· measuring…',
