...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _data = {
    'ru': {
      ...
      'vpn.empty': 'Добавьте подписку через кнопку +',
      'vpn.empty.hint': 'Или вставьте ссылку vless:// через «+» сверху',
    ...
    'en': {
      ...
      'vpn.empty': 'Add a subscription via the + button',
      'vpn.empty.hint': 'Or paste a vless:// link via the "+" above',
      'vpn.mode.proxy': 'PROXY',
      'vpn.mode.tun': 'TUN',
